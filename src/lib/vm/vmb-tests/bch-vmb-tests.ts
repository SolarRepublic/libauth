 ...
 * `bch_vmb_tests_*.json` files). Compiling from TypeScript allows us to easily
 ...
 *
 * - Tests marked with `standard` must pass in both standard and non-standard mode.
 * - Tests marked with `valid` must pass in non-standard mode but fail in standard mode.
 * - Tests marked with `invalid` must fail in both standard and non-standard mode.
 *
 ...
 *
 * For example, a test marked `['invalid', 'upgradeName_standard']` will be
 ...
 * additional upgrades or draft proposals can be generated by adding a filename
 * and definitions here.
 */
export const vmbTestFiles: {
  [filename in `bch_vmb_tests_${VmVersion}_${ExpectedBehavior}`]: [ExpectedBehavior, ...VersionOverride[]];
} = {
...
export type VmbTestDefinition = [
   ...
   * as `valid`.
   *
   * For greater control over which types of tests are generated, use the
   * `nonP2sh`, `p2sh20`, `p2sh32` properties in `otherProperties`.
   */
  ...
  otherProperties?: {
    ...
    /**
     * If `true`, generate the non-P2SH version of this test – the resulting
     * transaction will include the contract directly in the output's locking
     * bytecode. (Default: `true`)
     */
    nonP2sh?: boolean;
    /**
     * If `true`, generate the P2SH20 version of this test. (Default: `true`)
     */
    p2sh20?: boolean;
    /**
     * If `true`, generate the P2SH32 version of this test. (Default: `false`)
     */
    p2sh32?: boolean;
  }
];
export type VmbTestDefinitionGroup = [groupDescription: string, tests: VmbTestDefinition[]];
/**
 ...
 */
export const bchVmbTestDefinitions: VmbTestDefinitionGroup[] = [
  [
    ...
    [
      ...
      ['OP_PUSHBYTES_1', 'OP_SIZE <1> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_1 with missing bytes'],
      ['OP_PUSHBYTES_2 0x00', 'OP_SIZE <2> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_2 with missing bytes'],
      ['OP_PUSHBYTES_3 0x00', 'OP_SIZE <3> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_3 with missing bytes'],
      ['OP_PUSHBYTES_4 0x00', 'OP_SIZE <4> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_4 with missing bytes'],
      ['OP_PUSHBYTES_5 0x00', 'OP_SIZE <5> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_5 with missing bytes'],
      ['OP_PUSHBYTES_6 0x00', 'OP_SIZE <6> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_6 with missing bytes'],
      ['OP_PUSHBYTES_7 0x00', 'OP_SIZE <7> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_7 with missing bytes'],
      ['OP_PUSHBYTES_8 0x00', 'OP_SIZE <8> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_8 with missing bytes'],
      ['OP_PUSHBYTES_9 0x00', 'OP_SIZE <9> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_9 with missing bytes'],
      ['OP_PUSHBYTES_10 0x00', 'OP_SIZE <10> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_10 with missing bytes'],
      ['OP_PUSHBYTES_11 0x00', 'OP_SIZE <11> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_11 with missing bytes'],
      ['OP_PUSHBYTES_12 0x00', 'OP_SIZE <12> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_12 with missing bytes'],
      ['OP_PUSHBYTES_13 0x00', 'OP_SIZE <13> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_13 with missing bytes'],
      ['OP_PUSHBYTES_14 0x00', 'OP_SIZE <14> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_14 with missing bytes'],
      ['OP_PUSHBYTES_15 0x00', 'OP_SIZE <15> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_15 with missing bytes'],
      ['OP_PUSHBYTES_16 0x00', 'OP_SIZE <16> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_16 with missing bytes'],
      ['OP_PUSHBYTES_17 0x00', 'OP_SIZE <17> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_17 with missing bytes'],
      ['OP_PUSHBYTES_18 0x00', 'OP_SIZE <18> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_18 with missing bytes'],
      ['OP_PUSHBYTES_19 0x00', 'OP_SIZE <19> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_19 with missing bytes'],
      ['OP_PUSHBYTES_20 0x00', 'OP_SIZE <20> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_20 with missing bytes'],
      ['OP_PUSHBYTES_21 0x00', 'OP_SIZE <21> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_21 with missing bytes'],
      ['OP_PUSHBYTES_22 0x00', 'OP_SIZE <22> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_22 with missing bytes'],
      ['OP_PUSHBYTES_23 0x00', 'OP_SIZE <23> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_23 with missing bytes'],
      ['OP_PUSHBYTES_24 0x00', 'OP_SIZE <24> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_24 with missing bytes'],
      ['OP_PUSHBYTES_25 0x00', 'OP_SIZE <25> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_25 with missing bytes'],
      ['OP_PUSHBYTES_26 0x00', 'OP_SIZE <26> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_26 with missing bytes'],
      ['OP_PUSHBYTES_27 0x00', 'OP_SIZE <27> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_27 with missing bytes'],
      ['OP_PUSHBYTES_28 0x00', 'OP_SIZE <28> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_28 with missing bytes'],
      ['OP_PUSHBYTES_29 0x00', 'OP_SIZE <29> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_29 with missing bytes'],
      ['OP_PUSHBYTES_30 0x00', 'OP_SIZE <30> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_30 with missing bytes'],
      ['OP_PUSHBYTES_31 0x00', 'OP_SIZE <31> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_31 with missing bytes'],
      ['OP_PUSHBYTES_32 0x00', 'OP_SIZE <32> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_32 with missing bytes'],
      ['OP_PUSHBYTES_33 0x00', 'OP_SIZE <33> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_33 with missing bytes'],
      ['OP_PUSHBYTES_34 0x00', 'OP_SIZE <34> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_34 with missing bytes'],
      ['OP_PUSHBYTES_35 0x00', 'OP_SIZE <35> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_35 with missing bytes'],
      ['OP_PUSHBYTES_36 0x00', 'OP_SIZE <36> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_36 with missing bytes'],
      ['OP_PUSHBYTES_37 0x00', 'OP_SIZE <37> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_37 with missing bytes'],
      ['OP_PUSHBYTES_38 0x00', 'OP_SIZE <38> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_38 with missing bytes'],
      ['OP_PUSHBYTES_39 0x00', 'OP_SIZE <39> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_39 with missing bytes'],
      ['OP_PUSHBYTES_40 0x00', 'OP_SIZE <40> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_40 with missing bytes'],
      ['OP_PUSHBYTES_41 0x00', 'OP_SIZE <41> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_41 with missing bytes'],
      ['OP_PUSHBYTES_42 0x00', 'OP_SIZE <42> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_42 with missing bytes'],
      ['OP_PUSHBYTES_43 0x00', 'OP_SIZE <43> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_43 with missing bytes'],
      ['OP_PUSHBYTES_44 0x00', 'OP_SIZE <44> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_44 with missing bytes'],
      ['OP_PUSHBYTES_45 0x00', 'OP_SIZE <45> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_45 with missing bytes'],
      ['OP_PUSHBYTES_46 0x00', 'OP_SIZE <46> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_46 with missing bytes'],
      ['OP_PUSHBYTES_47 0x00', 'OP_SIZE <47> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_47 with missing bytes'],
      ['OP_PUSHBYTES_48 0x00', 'OP_SIZE <48> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_48 with missing bytes'],
      ['OP_PUSHBYTES_49 0x00', 'OP_SIZE <49> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_49 with missing bytes'],
      ['OP_PUSHBYTES_50 0x00', 'OP_SIZE <50> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_50 with missing bytes'],
      ['OP_PUSHBYTES_51 0x00', 'OP_SIZE <51> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_51 with missing bytes'],
      ['OP_PUSHBYTES_52 0x00', 'OP_SIZE <52> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_52 with missing bytes'],
      ['OP_PUSHBYTES_53 0x00', 'OP_SIZE <53> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_53 with missing bytes'],
      ['OP_PUSHBYTES_54 0x00', 'OP_SIZE <54> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_54 with missing bytes'],
      ['OP_PUSHBYTES_55 0x00', 'OP_SIZE <55> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_55 with missing bytes'],
      ['OP_PUSHBYTES_56 0x00', 'OP_SIZE <56> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_56 with missing bytes'],
      ['OP_PUSHBYTES_57 0x00', 'OP_SIZE <57> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_57 with missing bytes'],
      ['OP_PUSHBYTES_58 0x00', 'OP_SIZE <58> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_58 with missing bytes'],
      ['OP_PUSHBYTES_59 0x00', 'OP_SIZE <59> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_59 with missing bytes'],
      ['OP_PUSHBYTES_60 0x00', 'OP_SIZE <60> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_60 with missing bytes'],
      ['OP_PUSHBYTES_61 0x00', 'OP_SIZE <61> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_61 with missing bytes'],
      ['OP_PUSHBYTES_62 0x00', 'OP_SIZE <62> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_62 with missing bytes'],
      ['OP_PUSHBYTES_63 0x00', 'OP_SIZE <63> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_63 with missing bytes'],
      ['OP_PUSHBYTES_64 0x00', 'OP_SIZE <64> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_64 with missing bytes'],
      ['OP_PUSHBYTES_65 0x00', 'OP_SIZE <65> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_65 with missing bytes'],
      ['OP_PUSHBYTES_66 0x00', 'OP_SIZE <66> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_66 with missing bytes'],
      ['OP_PUSHBYTES_67 0x00', 'OP_SIZE <67> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_67 with missing bytes'],
      ['OP_PUSHBYTES_68 0x00', 'OP_SIZE <68> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_68 with missing bytes'],
      ['OP_PUSHBYTES_69 0x00', 'OP_SIZE <69> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_69 with missing bytes'],
      ['OP_PUSHBYTES_70 0x00', 'OP_SIZE <70> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_70 with missing bytes'],
      ['OP_PUSHBYTES_71 0x00', 'OP_SIZE <71> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_71 with missing bytes'],
      ['OP_PUSHBYTES_72 0x00', 'OP_SIZE <72> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_72 with missing bytes'],
      ['OP_PUSHBYTES_73 0x00', 'OP_SIZE <73> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_73 with missing bytes'],
      ['OP_PUSHBYTES_74 0x00', 'OP_SIZE <74> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_74 with missing bytes'],
      ['OP_PUSHBYTES_75 0x00', 'OP_SIZE <75> OP_EQUAL', ['invalid'], 'OP_PUSHBYTES_75 with missing bytes'],
    ],
  ],
  [
    'push number operations (OP_1NEGATE-OP_16)',
    [
      ['OP_1NEGATE', '<-1 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_1NEGATE pushes 0x81.'],
      ['OP_0', '<0x00> OP_CAT <0x00> OP_EQUAL', ['standard'], 'OP_0 pushes an empty stack item.'],
      ['OP_1', '<1 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_1 pushes 0x01.'],
      ['OP_2', '<2 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_2 pushes 0x02.'],
      ['OP_3', '<3 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_3 pushes 0x03.'],
      ['OP_4', '<4 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_4 pushes 0x04.'],
      ['OP_5', '<5 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_5 pushes 0x05.'],
      ['OP_6', '<6 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_6 pushes 0x06.'],
      ['OP_7', '<7 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_7 pushes 0x07.'],
      ['OP_8', '<8 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_8 pushes 0x08.'],
      ['OP_9', '<9 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_9 pushes 0x09.'],
      ['OP_10', '<10 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_10 pushes 0x0a.'],
      ['OP_11', '<11 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_11 pushes 0x0b.'],
      ['OP_12', '<12 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_12 pushes 0x0c.'],
      ['OP_13', '<13 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_13 pushes 0x0d.'],
      ['OP_14', '<14 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_14 pushes 0x0e.'],
      ['OP_15', '<15 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_15 pushes 0x0f.'],
      ['OP_16', '<16 0x00> <1> OP_SPLIT OP_DROP OP_EQUAL', ['standard'], 'OP_16 pushes 0x10.'],
    ],
  ],
];

export const bchVmbTests = bchVmbTestDefinitions.map(vmbTestGroupToVmbTests);
